...
{"spiked barricade", '^', c_brown,   8,
        mfb(noitem)|mfb(flammable)|mfb(razor)|mfb(transparent)},
{"wooden palisade",  '#', c_brown,   0,
        mfb(noitem)|mfb(flammable)|mfb(transparent)},
