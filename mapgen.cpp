...
// Rotate randomly...
  rotate(rng(0, 3));
// ... then place walls as needed.
  if (t_north != ot_museum_entrance && t_north != ot_museum)
   line(this, t_wall_h, 0, 0, SEEX * 2 - 1, 0);
  if (t_east != ot_museum_entrance && t_east != ot_museum)
   line(this, t_wall_v, SEEX * 2 - 1, 0, SEEX * 2 - 1, SEEY * 2 - 1);
  if (t_south != ot_museum_entrance && t_south != ot_museum)
   line(this, t_wall_h, 0, SEEY * 2 - 1, SEEX * 2 - 1, SEEY * 2 - 1);
  if (t_west != ot_museum_entrance && t_west != ot_museum)
   line(this, t_wall_v, 0, 0, 0, SEEY * 2 - 1);
  break;
